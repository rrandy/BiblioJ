...
<html>
	...
	<body>
		...
		<div id="show-auteur" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:auteurInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${auteurInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
